...
function preload() {
  ...
  font = loadFont('assets/NunitoSans-Bold.ttf');
}
...
function setup() {
  ...
  //button2 = ellipse(250, 100, 100, 100);
  // button1.position(100, 100);
  // button1.mousePressed(autumn);
  // textFont(font);
  // textSize(fontsize);
...
function draw() {
  ...
  if(winter0 == true){
    winter();
    // if(rect0 == true){
    //   rect(0, windowHeight*7, windowWidth, windowHeight*0.15);
    // }
  }
...
function summer() {
  ...
  // if(x4 ){
  //   // image(swim2, x4, windowHeight*0.75);
  // }
  x4 = x4 + speed3;

  // if(x5 < windowWidth){
  //   image(swim2, x5, windowHeight*0.75);
  // }
  // x5 = x5 - speed3;
...
//   if(y5 > windowHeight*0.85){
//     image(snowland, 0, windowHeight*7, windowWidth, windowHeight*0.15);
//   }
//
 }
